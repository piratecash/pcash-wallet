...
If your wallet balance and transactions are showing as expected you don't have to do anything. However, if you do not see a balance or transactions then you need to restore your wallet via the non-standard import option.

1. Go to the Settings tab
2. Select Manage Wallets
3. Click on Import Wallet
4. Select Non-Standard Import
5. Complete the import steps
