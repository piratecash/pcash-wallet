...
class SolanaNetworkPage : HSPage() {
...
private fun SolanaNetworkScreen(
    ...
    Surface(color = ComposeAppTheme.colors.tyler) {
        Column {
            ...
            SolanaNetworkList(viewModel, navigation)
        }
...
@Composable
private fun SolanaNetworkList(viewModel: SolanaNetworkViewModel, navigation: HSNavigation) {
    LazyColumn(
        ...
        item {
            ...
            BlockchainStatusButton {
                marketKit.blockchain(BlockchainType.Solana.uid)?.let { blockchain ->
