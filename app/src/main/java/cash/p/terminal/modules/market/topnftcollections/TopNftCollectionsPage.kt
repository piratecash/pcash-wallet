...
class TopNftCollectionsPage(val input: Input) : HSPage() {
    ...
    override fun GetContent(navigation: HSNavigation) {
        ...
        TopNftCollectionsScreen(
            ...
            { blockchainType, collectionUid ->
                val args = NftCollectionPage.Input(collectionUid, blockchainType.uid)
                navigation.slideFromBottom(NftCollectionPage(args))
            }
        )
    }
