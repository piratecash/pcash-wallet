...
class ActivateTokenPage(val input: Wallet) : HSPage() {
    @Composable
    override fun GetContent(navigation: HSNavigation) {
        ActivateTokenScreen(navigation, input) { result ->
...
fun ActivateTokenScreen(
    ...
    wallet: Wallet,
    onResult: (ActivateTokenPage.Result) -> Unit,
) {
    val viewModel =
                ...
                onClick = {
                    coroutineScope.launch {
                        ...
                        val result = try {
                            ...
                            ActivateTokenPage.Result(true)
                        } catch (t: Throwable) {
                            HudHelper.showErrorMessage(view, t.javaClass.simpleName)
                            ActivateTokenPage.Result(false)
                        }
