...
import cash.p.terminal.modules.restorelocal.RestoreLocalPage
...
class ImportWalletPage(val input: ManageAccountsModule.Input?) : HSPage() {
            ...
            Column(
                ...
                ImportOption(
                    ...
                    onClick = {
                        navigation.navigateWithTermsAccepted {
                            navigation.slideFromBottom(
                                RestoreAccountPage(ManageAccountsModule.Input(popUpToInclusiveId, inclusive))
                            )
                        }
                    }
                )
