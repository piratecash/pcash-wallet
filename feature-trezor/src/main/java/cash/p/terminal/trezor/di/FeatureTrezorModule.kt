...
import cash.p.terminal.trezor.client.TrezorEthereumDefinitionsProviderImpl
...
val featureTrezorModule = module {
    ...
    singleOf(::TrezorEthereumDefinitionsProviderImpl) bind TrezorEthereumDefinitionsProvider::class
