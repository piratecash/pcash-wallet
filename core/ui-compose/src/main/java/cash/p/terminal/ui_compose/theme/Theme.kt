...
val lightPalette = Colors(
    ...
    divider = DividerL,
    filterBackground = FilterBackgroundL,
    filterSettingsBackground = FilterSettingsBackgroundL,
    filterBorder = FilterBorderL,
...
val darkPalette = Colors(
    ...
    divider = DividerD,
    filterBackground = FilterBackgroundD,
    filterSettingsBackground = FilterSettingsBackgroundD,
    filterBorder = FilterBorderD,
